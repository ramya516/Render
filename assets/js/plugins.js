    ...
    var lax = function() {
        ...
        return lax.presets = {
            ...
            for (var i = l.el, e = [], t = 0; t < i.attributes.length; t++) {
                var a = i.attributes[t]; - 1 < a.name.indexOf("data-lax-preset") && e.push(a)
            }
            for (var n = function(t) {
                    ...
                    }), i.setAttribute("data-lax-anchor", "self"), i.attributes.removeNamedItem(a.name)
